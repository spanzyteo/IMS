...
<body class="paage svelte-18jj8gf"><div class="login-container w-fit md:w-fit lg:w-2/4 svelte-18jj8gf"><div class="text-center p-[5rem] rounded-xl shadow-slate-700"><h3 class="text-3xl text-[rgb(87,242,135)] font-bold p-3">Create Account</h3>
