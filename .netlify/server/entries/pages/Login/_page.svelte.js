...
<body class="page svelte-1760y9o"><div class="login-container w-2/4"><div class="login-container"><form class="svelte-1760y9o"><div class="text-center p-[5rem] rounded-xl shadow-slate-700"><h3 class="text-3xl text-[rgb(87,242,135)] font-bold pb-3">Login Your Account</h3>
					<div class="form__group field mb-3"><input required type="email" name="email" class="form__field" placeholder="Enter Email Address"${add_attribute("value", details.email, 0)}>
					...
					<div class="form__group field"><input required type="password" name="password" class="form__field" placeholder="Enter Password"${add_attribute("value", details.password, 0)}>
